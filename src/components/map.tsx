...
export default function GalantaMap({ fairName, coords, setCoords }: CoordsProps) {
  ...
  return (
    <MapContainer center={[48.682366, 20.115659]} minZoom={14} maxZoom={18} style={{ height: "800px", width: "100%" }}>
